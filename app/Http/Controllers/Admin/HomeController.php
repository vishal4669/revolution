...
class HomeController
{
    public function index()
    {
        ...
        $settings2 = [
            'chart_title'           => 'Cycles for Rent',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Cycle',
        ...
        $settings4 = [
            'chart_title'           => 'Upcoming Events',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Event',
            'group_by_field'        => 'last_booking_date',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
        ...
        $settings6 = [
            'chart_title'           => 'Rented Trainers',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\TrainerSetting',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'trainerSetting',
        ];
        ...
        $settings7 = [
            'chart_title'           => 'Active Testimonials',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings8 = [
            'chart_title'           => 'Unique Event Registrations',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\EventRegistration',
            'group_by_field'        => 'created_at',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'eventRegistration',
        ];
        ...
        $settings10 = [
            'chart_title'           => 'Latest Event Registrations',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\EventRegistration',
            'group_by_field'        => 'created_at',
