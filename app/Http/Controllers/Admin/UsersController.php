...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('lname', function ($row) {
                return $row->lname ? $row->lname : '';
            });
            $table->editColumn('mobile', function ($row) {
                return $row->mobile ? $row->mobile : '';
            });
            $table->editColumn('add_1', function ($row) {
                return $row->add_1 ? $row->add_1 : '';
            });
            $table->editColumn('add_2', function ($row) {
                return $row->add_2 ? $row->add_2 : '';
            });
        ...
        $photo->thumbnail
            ...
            $table->rawColumns(['actions', 'placeholder', 'roles', 'image']);
