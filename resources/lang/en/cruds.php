...
return [
    ...
    'event' => [
        ...
        'fields'         => [
            ...
            'event_images_helper'      => 'Upload images for event.',
            'description'              => 'Description',
            'description_helper'       => 'Enter description.',
            'last_booking_date'        => 'Last Booking Date',
            'last_booking_date_helper' => 'Select last date for booking.',
            'event_start_day'          => 'Event Start Date',
            'event_start_day_helper'   => 'Select start date.',
            'location'                 => 'Location',
            'location_helper'          => 'Enter location.',
            'event_type'               => 'Event Type',
            'event_type_helper'        => 'Select event type.',
            ...
            'deleted_at_helper'        => ' ',
            'terms'                    => 'Terms',
            'terms_helper'             => 'Please enter terms and conditions.',
            'reporting_time'           => 'Reporting Time',
            'reporting_time_helper'    => 'Please set reporting time.',
            'start_time'               => 'Start Time',
            'start_time_helper'        => 'Please set event start time.',
            'end_time'                 => 'End Time',
            'end_time_helper'          => 'Please enter end time.',
        ],
    ],
    'ticket' => [
        'title'          => 'Tickets',
...
'trainerModule' => [
    ...
    'trainerCafe' => [
        'title'          => 'Trainer Cafe',
        'title_singular' => 'Trainer Cafe',
    ],
    'slotBooking' => [
        'title'          => 'Slot Booking',
        'title_singular' => 'Slot Booking',
        'fields'         => [
            'id'                  => 'ID',
            'id_helper'           => ' ',
            'user'                => 'User',
