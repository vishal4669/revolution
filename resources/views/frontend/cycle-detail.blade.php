      ...
      <div class="banner inner-banner1 ">
        <div class="container">
          <section class="banner-detail center-xs">
            <h1 class="banner-title">Cycle Details</h1>
            <div class="bread-crumb right-side float-none-xs">
              <ul>
                <li><a href="{{ route('home') }}">Home</a>/</li>
                <li><span>Cycle Details</span></li>
              </ul>
            </div>
          </section>
        </div>
          ...
          <div class="row">
                    ...
                    <div class="col-12">
                      <div class="product-detail-main">
                        <div class="product-item-details">
                          <h1 class="product-item-name">{{ ucfirst($cycle->name) }}</h1>
                          ...
                          <hr class="mb-20">
                          {!! Str::of($cycle->description)->limit(200); !!}
            ...
            <div class="col-xl-3 d-none d-xl-block">
              <div class="sub-banner-block align-center">
                <img src="{{ asset('frontend/images/pro-banner.jpg') }}" alt="Revolution Bike Store">
              </div>
            </div>
          </div>
        </div>
                      ...
                      <li>
                        <div class="items-Reviews">
                          <div class="comments-area">
                            <h4>Reviews<span> ({{ $cycle->comments->count() }})</span></h4>
                            <ul class="comment-list mt-30">
                            @foreach($cycle->comments as $comment)
                              <li>
                                ...
                                <ul class="comment-list child-comment">
                                  <li>
                                    <div class="comment-user"> <img width="61" src="{{ asset('frontend/images/f-icon.png') }}" alt="Revolution Bike Store"> </div>
                                    <div class="comment-detail">
                                      <div class="user-name">Revolution Bike Cafe</div>
                                      <div class="post-info">
                                      </div>
                                      <p>{{ $comment->reply }}</p>
                                    </div>
                          ...
                          <div class="main-form mt-30">
                            ...
                            <form method="post" id="cycleReviewForm" action="{{ route('cycles.addReview', $cycle->id) }}">
                              ...
                              <div class="row mt-30">
                                ...
                                <div class="col-12">
                                  <button type="submit" class="btn btn-color" form="cycleReviewForm">Submit</button>
                                </div>
                              </div>
                            </form>
                          </div>
                        ...
                        <div class="product-item">  
                          ...
                          <div class="product-details">
                            <div class="product-item-details">
                              ...
                              <div class="price-box"> 
                                <span class="price">₹ {{$relatedCycle->rent_hour}} / Per Hour</span> 
                              </div>
                            </div>
