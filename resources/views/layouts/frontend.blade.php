                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('cycle_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.cycles.index') }}">
                                            {{ trans('cruds.cycle.title') }}
                                        </a>
                                    @endcan
                                    @can('renting_cycle_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.renting-cycles.index') }}">
                                            {{ trans('cruds.rentingCycle.title') }}
                                        </a>
                                    @endcan
                                    @can('cycle_expense_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.cycle-expenses.index') }}">
                                    ...
                                    @endcan
                                    @can('ticket_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.tickets.index') }}">
                                            {{ trans('cruds.ticket.title') }}
                                        </a>
                                    @endcan
                                    @can('event_registration_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.event-registrations.index') }}">
                                    ...
                                    @endcan
                                    @can('trainer_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.trainers.index') }}">
                                            {{ trans('cruds.trainer.title') }}
                                        </a>
                                    @endcan
                                    @can('renting_trainer_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.renting-trainers.index') }}">
                                            {{ trans('cruds.rentingTrainer.title') }}
                                        </a>
                                    @endcan
                                    @can('trainer_expense_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.trainer-expenses.index') }}">
                                            {{ trans('cruds.trainerExpense.title') }}
                                        </a>
                                    @endcan
                                    @can('brand_access')
                                        <a class="dropdown-item" href="{{ route('frontend.brands.index') }}">
                                    ...
                                    @can('trainer_setting_access')
                                        <a class="dropdown-item" href="{{ route('frontend.trainer-settings.index') }}">
                                            {{ trans('cruds.trainerSetting.title') }}
                                        </a>
                                    @endcan
                                    @can('cycle_setting_access')
                                        <a class="dropdown-item" href="{{ route('frontend.cycle-settings.index') }}">
