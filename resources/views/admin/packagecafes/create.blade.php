...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="required" for="validity">Validity: (Months)</label>
                    {!! Form::number('validity', null, array('placeholder' => 'Validity','class' => 'form-control',
                    'id' => 'validity','onkeyup'=>'return
                    calculatePrice()')) !!}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::number('price_per_hour', null, array('placeholder' => 'Price (Per Hour)','onkeyup'=>'calculatePrice()','class' => 'form-control', 'id' => 'price_per_hour'))
                    !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::number('total_hours', null, array('placeholder' => 'Total Hours','onkeyup'=>'calculatePrice()','class' => 'form-control', 'id' => 'total_hours')) !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="required" for="total_price">Total Price:</label>
                    {!! Form::text('total_price', null, array('placeholder' => 'Total Price','class' =>
                    'form-control', 'id' => 'total_price', 'readonly'=>true)) !!}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="terms_n_conditions">Terms & Conditions:</label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::select('package_tax', array(''=>'Select Tax','10' => '10%', '12' => '12%',
                    '18'=>'18%'), null, ['class' => 'form-control', 'id' => 'package_tax']) !!}
                </div>
            </div>
        </div>
        <div class="form-group">
