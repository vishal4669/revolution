    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_1') ? 'is-invalid' : '' }}" type="text" name="add_1" id="add_1" value="{{ old('add_1', '') }}" required>
                @if($errors->has('add_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_2') ? 'is-invalid' : '' }}" type="text" name="add_2" id="add_2" value="{{ old('add_2', '') }}">
                @if($errors->has('add_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', 'Ahmedabad') }}" required>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', 'Gujarat') }}" required>
                @if($errors->has('state'))
