    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.fname_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="lname">{{ trans('cruds.user.fields.lname') }}</label>
                <input class="form-control {{ $errors->has('lname') ? 'is-invalid' : '' }}" type="text" name="lname" id="lname" value="{{ old('lname', $user->lname) }}">
                @if($errors->has('lname'))
                    <span class="text-danger">{{ $errors->first('lname') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.lname_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="required" for="add_1">{{ trans('cruds.user.fields.add_1') }}</label>
                <input class="form-control {{ $errors->has('add_1') ? 'is-invalid' : '' }}" type="text" name="add_1" id="add_1" value="{{ old('add_1', $user->add_1) }}" required>
                @if($errors->has('add_1'))
                    <span class="text-danger">{{ $errors->first('add_1') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.add_1_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="add_2">{{ trans('cruds.user.fields.add_2') }}</label>
                <input class="form-control {{ $errors->has('add_2') ? 'is-invalid' : '' }}" type="text" name="add_2" id="add_2" value="{{ old('add_2', $user->add_2) }}">
                @if($errors->has('add_2'))
                    <span class="text-danger">{{ $errors->first('add_2') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.add_2_helper') }}</span>
            </div>
            <div class="form-group">
