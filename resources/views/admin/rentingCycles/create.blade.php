...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.rentingCycle.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("renting-cycles.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('cycle') ? 'is-invalid' : '' }}" name="cycle_id"
                            id="cycle_id" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-check {{ $errors->has('booking_type') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="booking_type_{{ $key }}" name="booking_type"
                                value="{{ $key }}" {{ old('booking_type', '0') === (string) $key ? 'checked' : '' }} required>
                    ...
                    <div class="col-md-4" id="total_hours_div" style="display:none;">
                        ...
                        <input class="form-control {{ $errors->has('total_hours') ? 'is-invalid' : '' }}" type="text"
                            name="total_hours" id="total_hours" value="{{ old('total_hours', '') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('to_date') ? 'is-invalid' : '' }}" type="text"
                            name="to_date" id="to_date" value="{{ old('to_date') }}" readonly>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('total_days') ? 'is-invalid' : '' }}" type="number"
                            name="total_days" id="total_days" value="{{ old('total_days', '') }}" step="1" readonly>
            ...
            <div class="row" >
                <div class="col-md-4" id="price_per_day_div" style="display: none;">
                    <div class="form-group" >
                        ...
                        <input class="form-control {{ $errors->has('price_per_day') ? 'is-invalid' : '' }}" type="number"
                            name="price_per_day" id="price_per_day" value="{{ old('price_per_day', '') }}" step="1">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('total_rent') ? 'is-invalid' : '' }}" type="number"
                            name="total_rent" id="total_rent" value="{{ old('total_rent', '') }}" step="0.01" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('deposit_received') ? 'is-invalid' : '' }}" type="number"
                            name="deposit_received" id="deposit_received" value="{{ old('deposit_received', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <div class="form-check {{ $errors->has('payment_option') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="radio" id="payment_option_{{ $key }}" name="payment_option"
                        value="{{ $key }}" {{ old('payment_option', '0') === (string) $key ? 'checked' : '' }} required>
