...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.cycle.title_singular') }}
    </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cycle_cost') ? 'is-invalid' : '' }}" type="number" name="cycle_cost" id="cycle_cost" value="{{ old('cycle_cost', '') }}" step="0.01" required>
