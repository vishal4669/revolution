...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.cycleSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cycle-settings.update", [$cycleSetting->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cycle') ? 'is-invalid' : '' }}" name="cycle_id" id="cycle_id" required>
                    @foreach($cycles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cycle_id') ? old('cycle_id') : $cycleSetting->cycle->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('cycle'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_per_hour') ? 'is-invalid' : '' }}" type="number" name="rent_per_hour" id="rent_per_hour" value="{{ old('rent_per_hour', $cycleSetting->rent_per_hour) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_per_day') ? 'is-invalid' : '' }}" type="number" name="rent_per_day" id="rent_per_day" value="{{ old('rent_per_day', $cycleSetting->rent_per_day) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_per_week') ? 'is-invalid' : '' }}" type="number" name="rent_per_week" id="rent_per_week" value="{{ old('rent_per_week', $cycleSetting->rent_per_week) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_per_fortnight') ? 'is-invalid' : '' }}" type="number" name="rent_per_fortnight" id="rent_per_fortnight" value="{{ old('rent_per_fortnight', $cycleSetting->rent_per_fortnight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slot_booking_limit') ? 'is-invalid' : '' }}" type="number" name="slot_booking_limit" id="slot_booking_limit" value="{{ old('slot_booking_limit', $cycleSetting->slot_booking_limit) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('booking_amount') ? 'is-invalid' : '' }}" type="number" name="booking_amount" id="booking_amount" value="{{ old('booking_amount', $cycleSetting->booking_amount) }}" step="0.01">
