            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ticket_name') ? 'is-invalid' : '' }}" type="text" name="ticket_name" id="ticket_name" value="{{ old('ticket_name', '') }}" required>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('max_entries') ? 'is-invalid' : '' }}" type="number" name="max_entries" id="max_entries" value="{{ old('max_entries', '') }}" step="1" required>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('booked_tickets') ? 'is-invalid' : '' }}" type="number" name="booked_tickets" id="booked_tickets" value="{{ old('booked_tickets', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Ticket::STOP_BOOKING_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('stop_booking') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="stop_booking_{{ $key }}" name="stop_booking" value="{{ $key }}" {{ old('stop_booking', '0') === (string) $key ? 'checked' : '' }} required>
